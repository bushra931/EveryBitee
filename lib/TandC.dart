...
class TermsAndConditionsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: Colors.green),  // Arrow color set to green
          onPressed: () {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: const [
            ...
            SizedBox(height: 20),
            Text("5. Nutritional Information:",
                  style: TextStyle(color:Color.fromARGB(255, 60, 112, 0)),
            ),
            Text(
            ...
            SizedBox(height: 20),
            Text("6. Privacy and Data Collection:",
                  style: TextStyle(color:Color.fromARGB(255, 60, 112, 0)),
            ),
            Text(
